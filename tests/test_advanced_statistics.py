"""
Tests pour le module AdvancedStatisticsEngine
============================================

Tests unitaires pour les statistiques avancées avec polymorphisme.
"""
...
class TestAdvancedStatisticsEngine(unittest.TestCase):
    """Tests pour AdvancedStatisticsEngine"""
    ...
    def setUp(self):
        ...
        # Données de test
        self.sample_data_list = [15, 23, 8, 42, 19, 31, 7, 28, 45, 12]
    ...
    def test_polymorphism_list(self):
        ...
        scores = self.engine.get_detailed_scores(self.sample_data_list)
    ...
    def test_polymorphism_series(self):
        ...
        scores = self.engine.get_detailed_scores(self.sample_data_series)
    ...
    def test_polymorphism_array(self):
        ...
        scores = self.engine.get_detailed_scores(self.sample_data_array)
    ...
    def test_consistency_across_types(self):
        ...
        scores_list = self.engine.get_detailed_scores(self.sample_data_list)
        scores_series = self.engine.get_detailed_scores(self.sample_data_series)
        scores_array = self.engine.get_detailed_scores(self.sample_data_array)
    ...
    def test_variance_score(self):
        ...
        variance_score = self.engine.variance_score(self.sample_data_list)
    ...
    def test_coherence_score(self):
        ...
        coherence_score = self.engine.coherence_score(self.sample_data_list)
    ...
    def test_fractal_score(self):
        ...
        fractal_score = self.engine.fractal_score(self.sample_data_list)
    ...
    def test_entropy_score(self):
        ...
        entropy_score = self.engine.entropy_score(self.sample_data_list)
    ...
    def test_lunar_cycle_score(self):
        ...
        date = "2025-01-15"
        lunar_score = self.engine.lunar_cycle_score(date, self.sample_data_list)
    ...
    def test_equiprobability_test(self):
        ...
        result = self.engine.equiprobability_test(self.sample_data_list)
    ...
    def test_process_method(self):
        ...
        # Test avec liste
        results_list = self.engine.process(self.sample_data_list)
    ...
    def test_edge_cases(self):
        ...
        # Liste vide
        empty_scores = self.engine.get_detailed_scores([])
        self.assertIsInstance(empty_scores, dict)
        
        # Liste avec un seul élément
        single_scores = self.engine.get_detailed_scores([42])
        self.assertIsInstance(single_scores, dict)
        
        # Liste avec des valeurs identiques
        identical_scores = self.engine.get_detailed_scores([1, 1, 1, 1, 1])
